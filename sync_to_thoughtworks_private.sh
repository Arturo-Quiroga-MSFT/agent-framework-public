...
# Syncs AQ-THOUGHTWORKS-2026 directory to private thoughtworks-architecture repo
# Uses rsync method - works with gitignored directories (keeps public repo clean)
# Usage: ./sync_to_thoughtworks_private.sh [commit-message]
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}   ThoughtWorks Materials Sync Tool (rsync method)${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""

# Check if we're in the right directory
if [ ! -d "$THOUGHTWORKS_DIR" ]; then
...
echo ""
echo -e "${BLUE}📊 Files to sync from ${THOUGHTWORKS_DIR}/:${NC}"
find "$THOUGHTWORKS_DIR" -type f -name "*.md" | head -10 | sed 's/^/   /'
FILE_COUNT=$(find "$THOUGHTWORKS_DIR" -type f | wc -l | tr -d ' ')
...
rsync -av --delete \
    ...
    --exclude='*.pyc' \
    --exclude='__pycache__/' \
    "$THOUGHTWORKS_DIR/" "$PRIVATE_CLONE_DIR/"
...
echo -e "   https://github.com/Arturo-Quiroga-MSFT/thoughtworks-architecture"
echo ""
echo -e "${BLUE}📋 Summary:${NC}"
echo -e "   ${GREEN}✓${NC} AQ-THOUGHTWORKS-2026/ synced to private repo"
