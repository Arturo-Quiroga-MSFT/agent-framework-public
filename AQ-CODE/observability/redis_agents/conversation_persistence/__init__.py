...
agent = client.create_agent(
    ...
    description=(
        "REDIS DEMO: Conversation Persistence\n"
        "\n"
        f"Shows how RedisChatMessageStore persists conversations across sessions.\n"
        ...
        "\n"
        "Session 2 - Follow Up:\n"
        "  • Hi, I'm following up on my damaged order. What are my options?\n"
        "  • Can you remind me what we discussed earlier?\n"
        "\n"
        "PERSISTENCE TEST:\n"
        "Stop DevUI server (Ctrl+C), restart it, and continue the conversation!"
    ),
    instructions=(
