...
agent = client.create_agent(
    ...
    description=(
        ...
        "**Try these queries:**\n"
        "1. Hi! I'm Alice. I'm vegetarian and love Italian food.\n"
        "2. I prefer organic ingredients when possible.\n"
        "3. I live in Seattle, Washington.\n"
        "4. Can you recommend a restaurant for dinner tonight?\n"
        "5. What do you remember about my food preferences?\n"
        "6. I should mention I'm allergic to nuts.\n"
        "7. I prefer restaurants with outdoor seating.\n"
        "8. Recommend a restaurant considering everything you know.\n\n"
