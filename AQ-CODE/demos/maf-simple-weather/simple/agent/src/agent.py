...
import httpx
from agent_framework import ChatAgent, ChatClientProtocol, ai_function, HostedCodeInterpreterTool
...
def get_weather(
    ...
    """Return real weather data from OpenWeatherMap API."""
...
def create_agent(chat_client: ChatClientProtocol) -> AgentFrameworkAgent:
    ...
    base_agent = ChatAgent(
        ...
        instructions=dedent(
            ...
            You can also execute Python code for calculations, data analysis, and create visualizations.
            ...
            Code execution:
            - When asked to perform calculations, create plots, or analyze data, use the code interpreter tool.
            - Write clear, well-commented Python code.
            - Explain what the code will do before executing it.
            - For plots: Use matplotlib, save with plt.savefig('output.png'), and tell the user the file is saved.
            - After execution, explain the results in simple terms and mention where files are saved.
        ...
        tools=[update_proverbs, get_weather, go_to_moon, HostedCodeInterpreterTool()],
    )
